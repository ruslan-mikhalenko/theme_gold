    ...
    Basic: {
      ...
      MobileMenu: function () {
        ...
        if ($(".mobile_menu li.menu-item-has-children ul").length) {
          $(".mobile_menu li.menu-item-has-children").append('<div class="dropdown-btn"><span class="far fa-arrow-right"></span></div>');
      ...
      TwinMax: function () {
        ...
        $(window).on("mousemove", moveCursor), $("a, button, .zoom-cursor").on("mouseenter", zoomCursor), $(".trigger-close").on("mouseenter", closeCursor), $("a, button, .zoom-cursor, .trigger-close, .trigger-plus").on("mouseleave", defaultCursor);
      },
      MainSLider: function () {
